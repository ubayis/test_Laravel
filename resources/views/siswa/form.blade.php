    ...
    @include('templates/feedback')
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('siswa') }}" class="btn btn-purple"><i class="fa fa-chevron-left">
          </i> Kembali </a>
        </div>
        <div class="box-body">
		...
		<div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Lengkap">{!! @$result->alamat !!}</textarea>
            </div>
		</div> 
		...
		<div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="no_telp" class="form-control" placeholder="Masukan Nomor Telp" value="{{ @$result->no_telp }}"/>
            </div>
		</div> 
